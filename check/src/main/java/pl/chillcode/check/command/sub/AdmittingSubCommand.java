...
public final class AdmittingSubCommand extends Command {
    CheckCache checkCache;
    Config config;

    public AdmittingSubCommand(final MessageAPI messageAPI, final Map<Class<? extends Command>, CommandData> commandDataMap, final CheckCache checkCache, final Config config) {
